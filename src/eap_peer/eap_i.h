...
struct eap_method {
	 ...
	 */
	void * (*init)(struct eap_sm *sm); // 该eap_method对象的初始化函数
	 ...
	 */
	void (*free)(struct eap_method *method); // 释放eap_method对象内部资源
...
#define EAP_PEER_METHOD_INTERFACE_VERSION 1
	 ...
	 */
	struct eap_method *next; // 所有注册的eap_method对象都存储在一个单向链表中
